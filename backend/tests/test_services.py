...
from app.db.models import Vm, VmStatus, Platform
...
def test_vm_filters(db_session: Session):
    ...
    vm1 = create_vm_row(db_session, user, name="vm1", platform=Platform.proxmox, status=VmStatus.running)
    vm2 = create_vm_row(db_session, user, name="vm2", platform=Platform.vmware, status=VmStatus.powered_off)
