...
export const advancedFilterNames = ['cluster', 'environment', 'monitoring_enabled', 'node', 'os_family', 'owner', 'pmp_enabled', 'tag', 'application', 'ip_role', 'health', 'shutdown_stale', 'decommission_overdue', 'missing_ip'] as const;
